...
<!-- Mirrored from themesflat.co/html/critso-admin/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Oct 2025 21:59:49 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                    ...
                    <div class="left">
                        <div class="content">
                            ...
                            <div class="sign-in-inner">
                                ...
                                <form class="form-login flex flex-column gap24" accept-charset="utf-8" action="https://themesflat.co/html/critso-admin/index.html">
                                    <fieldset class="name">
                                        <div class="f14-regular mb-6">Full name</div>
                                        <input class="flex-grow" type="text" placeholder="Enter your name" name="name" tabindex="0" value="Jonatham Smith" aria-required="true" required="">
                                    </fieldset>
                                ...
                                <div class="f14-regular">
                                    ...
                                    <a href="sign-in.html" class="f14-bold">Sign In</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="right">
                        <img src="images/item/bg-sign-in.jpg" alt="">
                        <div class="text">
                            <img class="mb-12" src="images/item/sign-up.png" alt="">
...
<!-- Mirrored from themesflat.co/html/critso-admin/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Oct 2025 21:59:50 GMT -->
</html>