...
<!-- Mirrored from themesflat.co/html/critso-admin/transaction.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Oct 2025 21:59:42 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    <title>Critso - Crypto Dashboard Template</title>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="images/logo/logo.svg" data-light="images/logo/logo.svg" data-dark="images/logo/logo-dark.svg" >
                        </a>
                                ...
                                <ul class="">
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="dashboard-boxed.html" class="">
                                                    <div class="text">Boxed</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="dashboard-icon-hover.html" class="">
                                                    <div class="text">Icon Menu</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="dashboard-icon-default.html" class="">
                                    ...
                                    <li class="menu-item">
                                        <a href="transaction.html" class="menu-item-button active">
                                            <div class="icon">
                                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.10866 2.16699H13.8912C16.7253 2.16699 18.3253 3.77449 18.3337 6.60866V14.392C18.3337 17.2253 16.7253 18.8337 13.8912 18.8337H6.10866C3.27449 18.8337 1.66699 17.2253 1.66699 14.392V6.60866C1.66699 3.77449 3.27449 2.16699 6.10866 2.16699ZM10.0412 15.3837C10.4003 15.3837 10.6995 15.117 10.7328 14.7587V6.26699C10.7662 6.00866 10.642 5.74949 10.417 5.60866C10.1828 5.46699 9.89949 5.46699 9.67533 5.60866C9.44949 5.74949 9.32533 6.00866 9.34949 6.26699V14.7587C9.39199 15.117 9.69116 15.3837 10.0412 15.3837ZM13.8753 15.3837C14.2253 15.3837 14.5245 15.117 14.567 14.7587V12.0253C14.5912 11.7578 14.467 11.5087 14.2412 11.367C14.017 11.2253 13.7337 11.2253 13.5003 11.367C13.2745 11.5087 13.1503 11.7578 13.1837 12.0253V14.7587C13.217 15.117 13.5162 15.3837 13.8753 15.3837ZM6.84949 14.7587C6.81616 15.117 6.51699 15.3837 6.15783 15.3837C5.79949 15.3837 5.49949 15.117 5.46699 14.7587V9.00033C5.44199 8.74116 5.56616 8.48366 5.79199 8.34199C6.01616 8.20033 6.30033 8.20033 6.52533 8.34199C6.74949 8.48366 6.87533 8.74116 6.84949 9.00033V14.7587Z" fill="#F8F8F8"/>
                                                </svg>
                                            </div>
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="content flex flex-column">
                                                    <span class="label-02 text-Black name">Jonathan</span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3" >
                                            ...
                                            <li>
                                                <a href="sign-in.html" class="user-item">
                                    ...
                                    <div class="table-list-transaction">
                                        <div class="list-transaction-head title-sort">
                                            ...
                                            <div class="btn-key-sort" data-index="2" data-type="string">
                                                <div class="f12-bold text-White">Form</div>
                                            ...
                                            <div class="btn-key-sort" data-index="3" data-type="string">
                                                <div class="f12-bold text-White">To</div>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6.53338 3.9199C6.53338 4.03073 6.49253 4.14158 6.40503 4.22908C6.23587 4.39825 5.95587 4.39825 5.7867 4.22908L3.92587 2.36825L2.06503 4.22908C1.89586 4.39825 1.61587 4.39825 1.4467 4.22908C1.27753 4.05992 1.27753 3.77992 1.4467 3.61075L3.61672 1.44073C3.69838 1.35906 3.8092 1.31242 3.92587 1.31242C4.04253 1.31242 4.15338 1.35906 4.23505 1.44073L6.40503 3.61075C6.4867 3.69825 6.53338 3.80906 6.53338 3.9199Z" fill="white"/>
                                                    <path d="M4.36328 1.75L4.36328 12.25C4.36328 12.4892 4.16495 12.6875 3.92578 12.6875C3.68661 12.6875 3.48828 12.4892 3.48828 12.25L3.48828 1.75C3.48828 1.51083 3.68661 1.3125 3.92578 1.3125C4.16495 1.3125 4.36328 1.51083 4.36328 1.75Z" fill="white"/>
                                                    <path d="M12.6876 10.08C12.6876 10.1909 12.6468 10.3017 12.5593 10.3892L10.3893 12.5592C10.3076 12.6409 10.1968 12.6875 10.0802 12.6875C9.9635 12.6875 9.85265 12.6409 9.77098 12.5592L7.601 10.3892C7.43183 10.22 7.43183 9.94 7.601 9.77083C7.77016 9.60167 8.05016 9.60167 8.21933 9.77083L10.0802 11.6317L11.941 9.77083C12.1101 9.60167 12.3902 9.60167 12.5593 9.77083C12.6468 9.8525 12.6876 9.96335 12.6876 10.08Z" fill="white"/>
                                            ...
                                            <tbody>
                                                <tr class="tf-table-item checked">
                                                    <td>
                                                        <div class="tf-cart-checkbox">
                                                            ...
                                                            <div class="f12-medium text-break key-sort" data-title="Transaction ID : ">
                                                                #124567899654
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="f12-bold key-sort">
                                                            January 23, 2022 <br>
                                                            <span class="f12-medium">5.21 PM</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image">
                                                            ...
                                                            <div class="f12-medium name key-sort">Marquezz</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image">
                                                            ...
                                                            <div class="f12-medium name key-sort">Jarinas Tom</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image style-1">
                                                            ...
                                                            <div class="f12-bold key-sort">Bitcoin</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$455.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-YellowGreen">
                                                            <i class="icon icon-check"></i>
                                                            <span class="font-poppins key-sort">COMPLETED</span> 
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="tf-table-item">
                                                    <td>
                                                        <div class="tf-cart-checkbox">
                                                            <div class="tf-checkbox-wrapp">
                                                                <input class="checkbox-item" type="checkbox" name="transaction_checkbox">
                                                                <div>
                                                                    <i class="icon-check"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="f12-bold key-sort">
                                                            January 22, 2022 <br>
                                                            <span class="f12-medium">5.20 PM</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image">
                                                            ...
                                                            <div class="f12-medium name key-sort">Jack</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image">
                                                    ...
                                                    <td>
                                                        <div class="wrap-image style-1">
                                                            ...
                                                            <div class="f12-bold key-sort">Ethereum</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$455.00</div>
                                                ...
                                                <tr class="tf-table-item">
                                                    ...
                                                    <td>
                                                        <div class="wrap-image style-1">
                                                            <div class="image">
                                                                <img src="images/item/coin-3.png" alt="">
                                                            </div>
                                                            <div class="f12-bold key-sort">Monero</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$550.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-LightGray">
                                                            <span class="font-poppins key-sort">PENDING</span> 
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="tf-table-item">
                                                    ...
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$168.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-YellowGreen">
                                                            <i class="icon icon-check"></i>
                                                ...
                                                <tr class="tf-table-item">
                                                    ...
                                                    <td>
                                                        <div class="wrap-image">
                                                            ...
                                                            <div class="f12-medium name key-sort">Jonathan</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="wrap-image style-1">
                                                    ...
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$751.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-LightGray type-red">
                                                            <span class="font-poppins key-sort">CANCELED</span> 
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="tf-table-item">
                                                    ...
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$100.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-YellowGreen">
                                                            <i class="icon icon-check"></i>
                                                ...
                                                <tr class="tf-table-item checked">
                                                    ...
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$555.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-LightGray">
                                                            <span class="font-poppins key-sort">PENDING</span> 
                                                ...
                                                <tr class="tf-table-item">
                                                    ...
                                                    <td>
                                                        <div class="f12-medium key-sort" data-title="Amount : ">$451.00</div>
                                                    </td>
                                                    <td>
                                                        <div class="box-status bg-LightGray type-red">
                                                            <span class="font-poppins key-sort">CANCELED</span> 
...
<!-- Mirrored from themesflat.co/html/critso-admin/transaction.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Oct 2025 21:59:43 GMT -->
</html>